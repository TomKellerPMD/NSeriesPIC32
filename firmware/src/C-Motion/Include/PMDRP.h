...
#pragma pack()
#else    
    __attribute__((aligned(4))) BYTE m_txBuffer[TOTAL_PACKET_LENGTH];
    __attribute__((aligned(4))) BYTE m_rxBuffer[TOTAL_PACKET_LENGTH];
    __attribute__((aligned(4))) BYTE m_txHeader[PACKET_HEADER_LENGTH];
#endif    
